      ...
      case RouteList.backdrop:
        ...
        if (arguments is BackDropArguments) {
          ...
          if (arguments.brandId != null) {
            final routeSetting = RouteSettings(name: RouteList.brand);
            //settings.copyWith(name: RouteList.brand);
          ...
          if (isWordpressBlog) {
            final routeSetting = RouteSettings(name: RouteList.blogs);
            //settings.copyWith(name: RouteList.blogs);
            return _buildRoute(routeSetting, (context) {
          ...
          // Woo
          final routeSetting = RouteSettings(name: RouteList.products);
          //settings.copyWith(name: RouteList.products);
          return _buildRoute(routeSetting, (context) {
            final cateId = arguments.cateId;
            final cateName = arguments.cateName;
