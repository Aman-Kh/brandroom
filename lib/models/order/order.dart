...
class Order {
  ...
  Map<String, dynamic> toJson(CartModel cartModel, userId, paid) {
    ...
    try {
      ...
      // new fix expose the woocos rest api to woocommerce by useing WP REST API Controller enables ;
        ...
        params['meta_data'].addAll([
          {
            ...
            'value': cartModel.currencyRates![cartModel.currencyCode],
          },
          {
            'key': '_woocs_order_currency',
            'value': cartModel.currencyCode,
          },
        ]);
      }
    } catch (e, trace) {
