                      ...
                      children: [
                        ListTile(
                          ...
                          subtitle: Text(
                            ...
                            '$prefix ${PriceTools.getCurrencyFormatted(transaction.amount, currencyRate, currency: currency).toString()}',
                            style: Theme.of(context)
                                .textTheme
                                .headline5
                        ...
                        _buildInfoItem(
                          ...
                          // new fix for wallet currency rate
                          description: PriceTools.getCurrencyFormatted(
                                  transaction.balance, currencyRate,
                                  currency: currency)
                              .toString(),
