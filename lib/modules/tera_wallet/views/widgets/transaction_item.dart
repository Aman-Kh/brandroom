    ...
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          ...
          Text(
              '${S.of(context).walletBalance} \n ${PriceTools.getCurrencyFormatted(transaction.balance, currencyRate, currency: currency)!}'),
      ...
      trailing: Padding(
        ...
        child: Text(
          '$prefix ${PriceTools.getCurrencyFormatted(transaction.amount, currencyRate, currency: currency)!}',
